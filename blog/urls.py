...
urlpatterns = [
    ...
    path('blog/post/<int:pk>/unpublish/', views.post_unpublish, name='post_unpublish'),
    ...
    path('blog/post/<int:pk>/comment/allow/', views.comment_allow, name='comment_allow'),
    path('blog/post/<int:pk>/comment/exclude/', views.comment_exclude, name='comment_exclude'),
    path('blog/post/<int:pk>/comment/remove/', views.comment_remove, name='comment_remove'),
